...
public class Neo4jRelationshipAccessor extends StandardAccessorImpl {
	...
	public Neo4jRelationshipAccessor() {
		...
		this.declareArgument(
				new SourcedArgumentMetaImpl("relationship", null, null, new Class[] { Neo4jRelationship.class }));
	...
	public void onNew(INKFRequestContext aContext) throws Exception {
		...
		// Create Relationship
		RelationshipType vRelationshipType = RelationshipType.withName(aName);
		Relationship vRelationship = vOutgoingNode.createRelationshipTo(vIncomingNode, vRelationshipType);
	...
	public void onExists(INKFRequestContext aContext) throws Exception {
		...
		if (vRelationshipRepresentation != null) {
			...
			vResponse.setExpiry(INKFResponse.EXPIRY_FUNCTION,
					new RelationshipExpiry(vRelationshipRepresentation.getRelationship()));
		} else {
